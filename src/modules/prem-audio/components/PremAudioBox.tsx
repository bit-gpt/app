...
import PremAudioTabs from "./PremAudioTabs";
import PremRecordTabs from "./PremRecordTabs";
      ...
      <div className="max-w-[650px] mx-auto">
        <div className="tabs-header">
          <button
            ...
            className={clsx(activeTab === 0 && "bg-darkcharcoal", "rounded-tl rounded-tr")}
          >
            Audio
          </button>
          <button
            onClick={() => handleTabChange(1)}
            className={clsx(activeTab === 1 && "bg-darkcharcoal", "rounded-tl rounded-tr")}
          >
            Record
          </button>
        </div>
        <PremAudioTabs activeTab={activeTab} file={file} setFile={setFile} />
        <PremRecordTabs activeTab={activeTab} />
