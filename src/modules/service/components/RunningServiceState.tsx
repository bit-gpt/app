...
const RunningServiceState = ({ serviceId }: ServiceStateProps) => {
  ...
  return (
    <>
      <button
        className="border-[0.5px] border-brightgray rounded-[3px] py-1 px-3 text-[10px] font-proximaNova-regular"
